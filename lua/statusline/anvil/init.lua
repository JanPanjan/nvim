...
M.mode_map = setmetatable({
	['n']    = 'NOR',  -- Normal
	['no']   = 'NOR-P', -- Operator pending
	['v']    = 'VIS',  -- Select by character
	['V']    = 'VIS-L', -- Select by line
	['\022'] = 'VIS-B', -- Select block wise, does not work cannot map symbol (^V)
	['s']    = 'SEL',  -- Select by character (gh)
	['S']    = 'SEL-L', -- Select by line (gH)
	['\019'] = 'SEL-B', -- Select block wise (g CTRL-H), does not work cannot map symbol (^S)
	['i']    = 'INS',  -- Insert
	['ic']   = 'INS~', -- Insert completion (generic)
	['ix']   = 'INS~', -- Insert completion (CTRL-X)
	['R']    = 'REP',  -- Replace
	['Rc']   = 'REP~', -- Replace completion
	['Rv']   = 'REP-V', -- Replace virtual
	['c']    = 'CMD',  -- Command-line
	['cv']   = 'CMD!', -- Execute (gQ)
	['ce']   = 'CMD!', -- Execute (Q)
	['r']    = 'PRO',  -- Prompt for enter
	['rm']   = 'PRO!', -- Read more (-- more -- prompt)
	['r?']   = 'PRO?', -- Prompt yes/no (confirmation prompt)
	['!']    = 'SHE',  -- Shell execution
	['t']    = 'INS-T', -- Terminal mode (insert)
	['nt']   = 'NOR-T', -- Terminal mode (normal)
}, {
...
M.get_file_state = function()
	local name = vim.bo.filetype == 'help' and fn.expand('%:t') or fn.expand('%:t')
