...
vim.api.nvim_create_user_command("QuietLight", function()
	...
	vim.api.nvim_set_hl(0, "Comment", { fg = 'gray', bold = false })
	vim.api.nvim_set_hl(0, "Visual", { bg = 'NvimLightRed' })
	vim.api.nvim_set_hl(0, "WinSeparator", { bg = "none", fg = "NvimLightGray2" })
	vim.api.nvim_set_hl(0, "Pmenu", { bg = 'NvimLightGray2' })
	vim.api.nvim_set_hl(0, "PmenuSel", { fg = 'Red', bg = 'NvimLightGray1' })
...
vim.api.nvim_create_user_command("LunarMud", function()
	...
	-- vim.api.nvim_set_hl(0, "NeoTreeFloatBorder", { bg = 'NvimDarkGray1', fg = 'NvimDarkGray1' })
	vim.api.nvim_set_hl(0, "NeoTreeFloatBorder", { bg = 'NvimDarkGray1', fg = 'NvimDarkGray1' })
end, {})
